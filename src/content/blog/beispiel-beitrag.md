...
- Ändern Sie die **Überschrift** oben im Formular
- Passen Sie den **Teaser** an (erscheint auf der Übersichtsseite unter [/news](/news))
- Fügen Sie einen **Link** ein, z. B. zur [Therme](/therme)
- Laden Sie ein **Bild** über die Mediathek hoch oder wählen Sie eines aus `public/images/blog`

## Beispiel-Liste

1. Titel und Datum im Frontmatter bearbeiten
2. Artikeltext im Feld „Article content“ bearbeiten
